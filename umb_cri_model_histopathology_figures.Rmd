...
df_ulcer <- rbind(
  load_ulcer_data("data/ulcer_area_and_histopath.xlsx", 
                  sheet = "2D Ulcer Area 987", range = "A1:I219"),
  load_ulcer_data("data/ulcer_area_and_histopath.xlsx", 
                  sheet = "2D Ulcer Area 903", range = "A1:I234"),
  load_ulcer_data("data/ulcer_area_and_histopath.xlsx", 
                  sheet = "2 D Ulcer Area 745", range = "A1:I267"),
  load_ulcer_data("data/ulcer_area_and_histopath.xlsx", 
                  sheet = "2D Ulcer Area 384", range = "A1:I232")
)

tmp |> 
  #group_by(time) |> 
  #summarise(time = time, mean_area )
  ggplot(aes(x = time, y = x2d_ulcer_area, group = wound_id, color = wound_id)) + 
  geom_point() + 
  geom_line() +
  theme_bw() +
